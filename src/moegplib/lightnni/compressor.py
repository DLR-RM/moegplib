""" Compressor classes: pruning and quantization.
...
from moegplib.lightnni import default_layers
...
class PrunerModuleWrapper(torch.nn.Module):
    def __init__(self, module, module_name, module_type, config, pruner):
        ...
        #print("here it is!!", self.weight_mask)

    def forward(self, *inputs):
        # apply mask to weight, bias
        #try:    
        #print("self.module.weight.data", self.module.weight.data)
        #print("self.weight_mask", self.weight_mask)
        ...
        #     self.module.module.weight.data = self.module.module.weight.data.mul_(self.weight_mask)
        #     if hasattr(self.module.module, 'bias') and self.module.module.bias is not None:
        #         self.module.module.bias.data = self.module.module.bias.data.mul_(self.bias_mask)
        ...
        for wrapper in self.get_modules_wrapper():
            ...
            if weight_mask is not None:
                ...
                try:
                    ...
                    wrapper.module.module.weight.data = wrapper.module.module.weight.data.mul(weight_mask)
