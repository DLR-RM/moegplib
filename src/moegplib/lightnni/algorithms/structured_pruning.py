""" Implementations of structured weight maskers: the following methods.
1. L1FilterPrunerMasker
2. L2FilterPrunerMasker
3. FPGMPrunerMasker
4. TaylorFOWeightFilterPrunerMasker
5. ActivationAPoZRankFilterPrunerMasker
6. ActivationMeanRankFilterPrunerMasker
7. SlimPrunerMasker
8. AMCWeightMasker
9. StructuredWeightMasker (a base class for the methods.)

Mostly prunes the filters.
...
from moegplib.lightnni.algorithms.weight_masker import WeightMasker
