""" Methods to fix the mask conflicts.
...
from moegplib.lightnni.utils.shape_dependency import ChannelDependency, GroupDependency, CatPaddingDependency, InputChannelDependency
