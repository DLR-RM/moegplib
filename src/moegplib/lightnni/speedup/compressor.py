""" Model speed up scripts; given the weight mask to be pruned,
the given class produces model that can be speeded up.
...
from moegplib.lightnni.utils.mask_conflict import fix_mask_conflict
from moegplib.lightnni.utils.utils import get_module_by_name
from moegplib.lightnni.graph_utils import build_module_graph
from moegplib.lightnni.speedup.compress_modules import replace_module
from moegplib.lightnni.speedup.infer_shape import ModuleMasks, infer_from_mask, infer_from_inshape, infer_from_outshape, set_conv_prune_dim
