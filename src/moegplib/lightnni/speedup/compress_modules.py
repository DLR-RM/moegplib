""" Modules for compression. Wraps the existing layers with 
the computations of masks to be compressed.
...
from moegplib.lightnni.speedup.infer_shape import ModuleMasks
